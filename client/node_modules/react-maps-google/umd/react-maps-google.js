/*! react-maps-google v0.1.6 | (c) 2018 Ryan Hefner | MIT License | https://github.com/ryanhefner/react-maps-google !*/
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-dom')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-dom'], factory) :
	(factory((global['react-maps-google'] = {}),global.React,global.ReactDOM));
	...
	*/
	...
	var MarkerClusterer = function (_Component) {
	  inherits(MarkerClusterer, _Component);
	...
	var GoogleMap = function (_Component) {
	  inherits(GoogleMap, _Component);

	  function GoogleMap(props) {
	    classCallCheck(this, GoogleMap);
	  ...
	  GoogleMap.prototype.renderMap = function renderMap() {
	    ...
	    Object.keys(CALLBACK_MAP$1).forEach(function (key) {
	      google.maps.event.addListener(map, key, _this2.onMapCallback.bind(_this2, CALLBACK_MAP$1[key]));
	    });
	  ...
	  GoogleMap.prototype.render = function render() {
	    ...
	    return React__default.createElement(
	      ...
	      null,
	      scriptLoaded === false && React__default.createElement(Script, {
